...
namespace ABMC_Clientes.Data_sets {
    ...
    public partial class dstGeneral : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientesRow AddClientesRow(string razon_social, string cuit, string calle, string numero, System.DateTime fecha_alta, string Barrio, string Contacto) {
        ...
        public partial class FacturasDataTable : global::System.Data.TypedTableBase<FacturasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public FacturasRow AddFacturasRow(string numero_factura, System.DateTime fecha, decimal Total, string cliente, string usuario_creador) {
...
namespace ABMC_Clientes.Data_sets.dstGeneralTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT c.id_cliente, c.razon_social, c.cuit, c.calle, c.numero, c.fecha_alta, b.n" +
                "ombre as Barrio, Co.nombre + Co.apellido as Contacto\r\nFROM Clientes c\r\nJoin Barr" +
                "ios b on (c.id_barrio = b.id_barrio)\r\nJoin Contactos Co on (Co.id_contacto = c.i" +
                "d_contacto)";
    ...
    public partial class FacturasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"Select f.id_factura, f.numero_factura, c.razon_social as cliente, f.fecha, u.usuario as usuario_creador, (SELECT SUM(precio) from FacturasDetalle fd where f.id_factura = fd.id_factura) as Total
